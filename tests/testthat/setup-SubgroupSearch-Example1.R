  ...
  endpoint_parameters_e1_s1 = list(
  ...
  endpoint_parameters_e1_s2 = list(
    outcome_variable = "outcome", 
    type = "continuous",
    label = "Outcome", 
